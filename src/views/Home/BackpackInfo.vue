...
@Component
export default class BackpackInfo extends Vue {
  // data
  part = 0;
  equipValue = 0;
  equipType = "1";
  ...
  handleDelete(
    index: any,
    row: { ItemNum: number; ItemId: string; ItemName: string },
    k: number
  ) {
    this.k = k;
  ...
  // 设置装备属性按钮
  changeequipattr(index: any, row: { Part: any }) {
    this.k = 3;
